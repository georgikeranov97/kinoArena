...
var reklamenPanel3=document.querySelector('#reklamenPanel3')
    ...
    radio1.addEventListener('click',moveSlide,false)
    radio2.addEventListener('click',moveSlide,false)
    radio3.addEventListener('click',moveSlide,false)
    
    radio4.addEventListener('click',moveSlide2,false)
    radio5.addEventListener('click',moveSlide2,false)
    radio6.addEventListener('click',moveSlide2,false)

    radio7.addEventListener('click',moveSlide3,false)
    radio8.addEventListener('click',moveSlide3,false)
